=== Сообщение от Гудвина ===
В эту версию плагина я внес одно изменение - убрал из него файл, формирующий виджет (EmailSubscriptionWidget.php)
Причина: ошибка, которую данный файл вызывал на сайте - 
...
Я просил автора плагина исправить эту ошибку, но не получил ответа. Между тем, плагин классный - очень простой, удобный, лёгкий. Отказываться от него мне не хочется, 
поэтому я убрал проблемый участок. Теперь плагин не вызывает ошибки и работает как часы.

Оригинальную версию можно загрузить здесь: 
